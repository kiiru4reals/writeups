Now that we have installed Wazuh, we need to set it up and configure it. When you first login you are redirected to the Wazuh homepage. In this case, I am using the elastic stack deployment.
